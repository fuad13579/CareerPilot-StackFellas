...
upsert_label "database"        "8e44ad" "Database schema, storage, and persistence work"
upsert_label "docker-devops"   "2980b9" "Docker, container setup, and DevOps tasks"
upsert_label "security-env"    "c0392b" "Security, secrets, and environment configuration"
upsert_label "architecture"    "34495e" "System design and technical architecture decisions"
upsert_label "api-integration" "16a085" "External or internal API integration work"
upsert_label "pr-review"       "9b59b6" "Pull request review and feedback needed"
upsert_label "final-submission" "f1c40f" "Final demo, packaging, and submission tasks"
